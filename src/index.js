...
import OmniApp from 'vlocityomniscript/omnioutCaseCreationEnglish';
/**
...
if (isCompatibleBrowser) {
     ...
     */
    if (!customElements.get('c--omniout--case-creation-english')) {
        customElements.define('c--omniout--case-creation-english', OmniApp.CustomElementConstructor);
    }
}
