...
import { OMNIDEF } from './omnioutCaseCreationEnglish_def.js';
import tmpl from './omnioutCaseCreationEnglish.html';
import tmpl_nds from './omnioutCaseCreationEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class omnioutCaseCreationEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
